...
- **BUG-URL-BE-007**: Query parameter validation bypass in links controller — used `req.query as unknown as ...` instead of validated schema. Fixed to use `linkQuerySchema.parse(req.query)` (`links.controller.ts`)

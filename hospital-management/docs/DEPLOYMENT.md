# Deployment Guide — Hospital Management

This guide covers how to deploy the Hospital Management System in development, staging, and production using Docker or manual setup.
...
|---|---|---|
| `DATABASE_URL` | PostgreSQL connection string | `postgresql://user:pass@localhost:5432/hospital_db` |
...
| `SMTP_FROM` | From email address | `noreply@hospital.com` |
...
| frontend | 3000 | Vite dev server / Nginx |

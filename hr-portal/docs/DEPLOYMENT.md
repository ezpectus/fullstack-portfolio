...
This guide covers how to deploy the HR Portal in development, staging, and production using Docker or manual setup.
...
|---|---|---|
| `DATABASE_URL` | PostgreSQL connection string | `postgresql://user:pass@localhost:5432/hr_portal_db` |
...
| `SMTP_FROM` | From email address | `noreply@hrportal.com` |
...
- Verify `MAX_FILE_SIZE` is not too small

# Deployment Guide — Booking System

This guide covers how to deploy the Booking System in development, staging, and production using Docker or manual setup.
...
| `SMTP_FROM` | From email address | `noreply@bookingsystem.com` |

...
- **Error handling:** centralized error middleware, typed error class
...
Example: `feat(books): add full-text search functionality`

## Pull Requests

1. Create a feature branch: `feat/library-<feature>`
2. Make your changes

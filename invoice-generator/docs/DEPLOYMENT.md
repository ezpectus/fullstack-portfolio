...
This guide covers how to deploy the Invoice Generator in development, staging, and production using Docker or manual setup.
...
|---|---|---|
| `DATABASE_URL` | PostgreSQL connection string | `postgresql://user:pass@localhost:5432/invoice_gen_db` |
...
| `SMTP_FROM` | From email address | `noreply@invoicegen.com` |
...
- [ ] SMTP configured for sending invoices

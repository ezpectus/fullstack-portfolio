...
echo.
echo [96m========================================[0m
echo [96m   CRM System - Starting (Docker)       [0m
echo [96m========================================[0m
echo.
...
if %errorlevel% neq 0 (
    echo [91m[ERROR] Docker Compose is not installed.[0m
    pause
    exit /b 1
)

echo [92m[OK] Docker Compose found[0m
...
echo [92m[OK] PostgreSQL: localhost:5432[0m
echo [92m[OK] Redis: localhost:6379[0m
echo.
